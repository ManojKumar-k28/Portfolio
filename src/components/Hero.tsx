  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        {/* Geometric Shapes */}
        <div className="absolute top-20 left-10 w-32 h-32 border border-cyan-400/20 rounded-full animate-spin-slow" aria-hidden="true"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 border border-purple-400/20 rotate-45 animate-pulse" aria-hidden="true"></div>
        <div className="absolute top-1/2 left-20 w-16 h-16 bg-gradient-to-r from-cyan-400/10 to-purple-400/10 rounded-lg animate-bounce" aria-hidden="true"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        ...
        <div className="lg:hidden flex flex-col items-center text-center space-y-6 sm:space-y-8">
          ...
          <div className="relative mb-4 sm:mb-8">
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full blur-3xl opacity-30 animate-pulse scale-110" aria-hidden="true"></div>
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-full animate-spin-slow p-1" aria-hidden="true">
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-2xl flex items-center justify-center shadow-xl animate-bounce" aria-hidden="true">
                <Code className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
              </div>
              <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-xl animate-pulse" aria-hidden="true">
          ...
          <div className="space-y-4 sm:space-y-6 w-full max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 pt-4 sm:pt-6 px-2 sm:px-4">
              <button
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-8 xl:gap-12 items-center">
          ...
          <div className="text-left space-y-6 xl:space-y-8">
            ...
            {/* FIX: Removed stray '<' and corrected the flex wrap class */}
            <div className="flex flex-wrap gap-4 xl:gap-6 pt-6 xl:pt-8">
              <button
                onClick={() => scrollToSection('projects')}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative w-72 h-72 xl:w-80 xl:h-80 2xl:w-96 2xl:h-96">
                ...
                <div className="absolute -top-4 -right-4 w-14 h-14 xl:w-16 xl:h-16 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-2xl flex items-center justify-center shadow-xl animate-bounce" aria-hidden="true">
                  <Code className="w-6 h-6 xl:w-8 xl:h-8 text-white" />
                </div>
                <div className="absolute -bottom-4 -left-4 w-14 h-14 xl:w-16 xl:h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-xl animate-pulse" aria-hidden="true">
